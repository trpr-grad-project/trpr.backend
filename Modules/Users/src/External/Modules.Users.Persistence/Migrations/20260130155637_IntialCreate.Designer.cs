...
namespace Modules.Users.Persistence.Migrations
{
    ...
    [Migration("20260130155637_IntialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Modules.Users.Persistence.Inbox.InboxConsumerMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Modules.Users.Persistence.Inbox.InboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Modules.Users.Persistence.Outbox.OutboxConsumerMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Modules.Users.Persistence.Outbox.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
