...
namespace Modules.Trips.Infrastructure.Migrations
{
    ...
    [Migration("20260705233332_AddReviews")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Modules.Trips.Domain.Entities.Trip", b =>
                {
                    ...
                    b.HasIndex("GuideId")
                        .HasDatabaseName("ix_trip_guide_id");
            ...
            modelBuilder.Entity("Modules.Trips.Domain.Entities.TripRating", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_trip_rating");

                    b.HasIndex("ReviewerId")
                        .HasDatabaseName("ix_trip_rating_reviewer_id");

                    b.HasIndex("TripId1")
                        .HasDatabaseName("ix_trip_rating_trip_id1");

                    b.HasIndex("TripId", "ReviewerId")
                        .IsUnique()
                        .HasDatabaseName("ix_trip_rating_trip_id_reviewer_id");

                    b.ToTable("trip_rating", "trp");
                });

            modelBuilder.Entity("Modules.Trips.Domain.Entities.TripReview", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_trip_review");

                    b.HasIndex("RevieweeId")
                        .HasDatabaseName("ix_trip_review_reviewee_id");

                    b.HasIndex("ReviewerId")
                        .HasDatabaseName("ix_trip_review_reviewer_id");

                    b.HasIndex("TripId", "ReviewerId", "RevieweeId")
                        .IsUnique()
                        .HasDatabaseName("ix_trip_review_trip_id_reviewer_id_reviewee_id");

                    b.ToTable("trip_review", "trp");
                });
            ...
            modelBuilder.Entity("Modules.Trips.Domain.Entities.Trip", b =>
                {
                    b.HasOne("Modules.Trips.Domain.Entities.User", "Guide")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_trip_user_guide_id");
            ...
            modelBuilder.Entity("Modules.Trips.Domain.Entities.TripRating", b =>
                {
                    b.HasOne("Modules.Trips.Domain.Entities.User", "Reviewer")
                        .WithMany()
                        .HasForeignKey("ReviewerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_trip_rating_user_reviewer_id");
                    ...
                    b.HasOne("Modules.Trips.Domain.Entities.Trip", "Trip")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_trip_rating_trip_trip_id");

                    b.HasOne("Modules.Trips.Domain.Entities.Trip", null)
                        .WithMany("TripRatings")
                        .HasForeignKey("TripId1")
                        .HasConstraintName("fk_trip_rating_trip_trip_id1");
            ...
            modelBuilder.Entity("Modules.Trips.Domain.Entities.TripReview", b =>
                {
                    b.HasOne("Modules.Trips.Domain.Entities.User", "Reviewee")
                        .WithMany()
                        .HasForeignKey("RevieweeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_trip_review_user_reviewee_id");
                    ...
                    b.HasOne("Modules.Trips.Domain.Entities.User", "Reviewer")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_trip_review_user_reviewer_id");
                    ...
                    b.HasOne("Modules.Trips.Domain.Entities.Trip", "Trip")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_trip_review_trip_trip_id");
