...
namespace Modules.Notifications.Infrastructure.Inbox
{
    ...
    where TIntegrationEvent : IIntegrationEvent
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            const string query = $"SELECT COUNT(1) FROM {Schema.Notifications}.inbox_consumer_messages WHERE id = @id AND handler_name = @HandlerName";
            ...
            const string insertQuery = $"INSERT INTO {Schema.Notifications}.inbox_consumer_messages (id, handler_name) VALUES (@Id, @HandlerName)";
