...
namespace Modules.Conversations.Infrastructure.Migrations
{
    ...
    [Migration("20260227120356_AddConversationEntities")]
            ...
            modelBuilder.Entity("Modules.Conversations.Domain.Entities.AiConversation", b =>
                {
                    ...
                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_ai_conversation_user_id");

                    b.ToTable("ai_conversation", "cnv");
                });
            ...
            modelBuilder.Entity("Modules.Conversations.Domain.Entities.AiMessage", b =>
                {
                    ...
                    b.HasIndex("ConversationId")
                        .HasDatabaseName("ix_ai_message_conversation_id");

                    b.HasIndex("ParentMessageId")
                        .HasDatabaseName("ix_ai_message_parent_message_id");

                    b.ToTable("ai_message", "cnv");
                });
            ...
            modelBuilder.Entity("Modules.Conversations.Domain.Entities.AiConversation", b =>
                {
                    b.HasOne("Modules.Conversations.Domain.Entities.User", "User")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_ai_conversation_users_user_id");
            ...
            modelBuilder.Entity("Modules.Conversations.Domain.Entities.AiMessage", b =>
                {
                    ...
                    b.HasOne("Modules.Conversations.Domain.Entities.AiMessage", "ParentAiMessage")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("fk_ai_message_ai_message_parent_message_id");
